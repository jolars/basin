//! ndarray-backend smoke tests for [`BoundedCmaInject`] with
//! [`Lbfgsb`] inner. Convergence on `BoothBoxed` plus the work-unit
//! aggregation lower bound confirm the per-backend trait wiring works
